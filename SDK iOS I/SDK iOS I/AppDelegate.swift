...
extension AppDelegate {
    func application(_: UIApplication, open url: URL, options _: [UIApplication.OpenURLOptionsKey: Any] = [:]) -> Bool {
        return decideFlow(from: url)
    }

    func decideFlow(from incomingURL: URL) -> Bool {
            ...
            incomingURL.absoluteString == "\(AuxiliaryConfiguration.scheme)://"
        {
            ...
            let alertController = UIAlertController(
                title: LocalizedStrings.AppDelegate.urlNotSupportedTitle,
                message: LocalizedStrings.AppDelegate.urlNotSupportedMessage,
                preferredStyle: .alert
            )
