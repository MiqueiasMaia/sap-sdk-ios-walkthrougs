...
class CustomerDetailViewController: FUIFormTableViewController, SAPFioriLoadingIndicator {
    ...
    private func cellForDateOfBirth(tableView: UITableView, indexPath: IndexPath, currentEntity: ESPMContainerFmwk.Customer, property: Property) -> UITableViewCell {
        ...
        return CellCreationHelper.cellForProperty(tableView: tableView, indexPath: indexPath, entity: entity, property: property, value: value, editingIsAllowed: allowsEditableCells, isAlternativeInputEnabled: true, alternativeButtonImage: FUIIconLibrary.system.calendar, didSelectAlternativeButtonHandler: {
        ...
        }, changeHandler: { (newValue: String) -> Bool in
            var isNewValueValid = false
            // The property is optional, so nil value can be accepted
            if newValue.isEmpty {
